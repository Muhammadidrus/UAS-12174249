				...
				<div class="row">
					<div class="col-lg-6">
						<div class="banner_content">
							...
							<p>
								Dengan Selembar Uang 50k anda Bisa merasakan Sensasi Lele
								yang Kriuk-Kriuk yang membuat lidah bergoyang, Dengan Sensasi Level Yang berbeda-beda.
							</p>
				...
				<div class="col-lg-4">
					<div class="single_feature d-flex flex-row pb-30">
						...
						<div class="desc">
							<h4>Menu Baru</h4>
							<p>
								Tersedia Lele Sambal Matah Tapi Mateng
								dengan Bumbu Bercita Rasa Tinggi Kearifan Local
							</p>
						</div>
					</div>
					<div class="single_feature d-flex flex-row pb-30">
						...
						<div class="desc">
							<h4>Menu Favorit</h4>
							<p>
								- Ikan Lele Kepala Lunak Tulang </p>
								<p>- Lele Saus Kurma </p>
								<p>- Brownis Lele
							</p>
						</div>
					...
					<div class="single_feature d-flex flex-row">
						...
						<div class="desc">
							...
							<p>
								Silakan Menghubungi Nomor di: </p>
								<p> 089657744875
									<p> atau Email Ke : </p>
								<p> Idrusmuhamamd21@gmail.com </p>
							</p>
						</div>
					</div>
				</div>
